...
class LoadingAnimation(ctk.CTk):
    def __init__(self):
        ...
        self.configure(bg="#242424")  # Set background color for the main window
    ...
    def animate(self):
        ...
        if self.current_frame == 0:
            # Pause after completing a full rotation
            self.after(1000, self.animate)  # 1000 milliseconds (1 second) pause
        else:
            self.after(50, self.animate)  # Reduced delay for smoother animation during rotation
