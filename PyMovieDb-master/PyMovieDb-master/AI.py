...
# Function to get movie recommendations based on user input and ratings
def get_genre_recommendations(user_genres, num_recommendations=50):
    # Combine multiple genres into a single string
    ...
    # Compute average similarity scores for the selected genre, considering ratings
    ...
    # Extract recommended movie titles and ratings
